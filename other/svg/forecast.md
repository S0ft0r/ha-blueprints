...
## 📝 Примеры анимаций
| Переменная облачность | Облачно | Дождь | Солнечно - высокий УФИ | Солнечно - УФИ в норме |
| :---: | :---: | :---: | :---: |  :---: | 
| <img src="./1.svg" width="50"> | <img src="./2.svg" width="50"> | <img src="./3.svg" width="50"> | <img src="./4.svg" width="50"> | <img src="./5.svg" width="50"> | 
---
**Автор:** [Softor]
**Лицензия:** MIT